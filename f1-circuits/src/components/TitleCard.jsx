      ...
      <>
        ...
        >
          ...
          <motion.svg
            ...
            viewport={{ once: true }}
          >
            <svg width="25" height="25" viewBox="0 0 161 107" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M54 0H0V107H54V0Z" fill="#009246" />
              <path d="M107 0H54V107H107V0Z" fill="white" />
              <path d="M161 0H107V107H161V0Z" fill="#CE2B37" />
            </svg>
